...
public class AccountController {
    ...
    @GetMapping
    public Page<AccountDTO> findAll(Pageable pageable, @RequestParam(value = "search", required = false) String search) {
        Page<Account> accounts = service.findAll(pageable, search);
